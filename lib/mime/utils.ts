...
export const isDocument = (mimeType: string) => /wordprocessingml|msword|odt|pages|epub/.test(mimeType);
export const isPresentation = (mimeType: string) => /presentation|powerpoint/.test(mimeType);
