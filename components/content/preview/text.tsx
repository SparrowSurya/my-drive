    ...
    >
      ...
      <div className="flex-1 bg-base rounded-lg border border-surface1 overflow-hidden flex flex-col relative shadow-2xl">
        <div className="absolute top-2 right-2 z-10">
          <button
            onClick={handleCopy}
            className="flex items-center justify-center rounded-md border py-1 border-surface1 bg-surface0 hover:bg-surface1 transition-colors text-subtext0 hover:text-text shadow-sm"
